...
# Summary of Metadata
## WARNING
Almost all data from 2017 in the Royal is flagged with a "Validation Comment" 
warning that the samples were "out of hold time", but relatively little data was
flagged with a data quality flag.
