...
PRV70	on 2020-09-24 had only two samples, making its regression estimates of k
unstable.  That date and location was the only time we have fewer than five 
light values on which to base an estimate of K. We deleted that date.
