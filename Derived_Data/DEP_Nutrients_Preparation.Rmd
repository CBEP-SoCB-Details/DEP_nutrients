...
# Extract Sonde Data
Ww also extract a subset of the data derived from sondes for independent review,
but as we dis not delete those data from the full data set, the two datasets 
